...
import com.deena.accounts.Constants.AccountsConstants;
import com.deena.accounts.Dto.AccountDto;
import com.deena.accounts.Dto.AccountsMsgDto;
...
import com.deena.accounts.Exception.CustomerAlreadyExists;
...
public class AccountsServiceImp implements AccountsService {
    ...
    private static final Logger log = LoggerFactory.getLogger(AccountsServiceImp.class);
    ...
    public void createAccount(CustomerDto customerDto) {
        ...
        if(optionalCustomer.isPresent()) {
            throw new CustomerAlreadyExists("Customer already registered with given mobileNumber "
